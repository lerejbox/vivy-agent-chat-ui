    ...
    return (
      <div className={cn("relative inline-block", className)}>
        ...
        {removable && (
          <button
            type="button"
            className="bg-muted text-muted-foreground hover:bg-accent hover:text-accent-foreground absolute top-1 right-1 z-10 rounded-full"
            onClick={onRemove}
    ...
    return (
      ...
      >
        ...
        {removable && (
          <button
            type="button"
            className="bg-background text-primary hover:bg-accent ml-2 self-start rounded-full p-1"
            onClick={onRemove}
  ...
  return (
    ...
    >
      ...
      {removable && (
        <button
          type="button"
          className="bg-background text-muted-foreground hover:bg-accent ml-2 rounded-full p-1"
          onClick={onRemove}
